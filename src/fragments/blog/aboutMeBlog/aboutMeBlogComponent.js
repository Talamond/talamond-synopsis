  ...
  renderContent() {
    return (<div className="blog-base content">
      <div className="blog-base paragraph">Beside coding I take part in other hobbies. I've been known to do all sorts
        ...
        In 2013 I created my own meetup group to facilitate my desire for trying random new things. Its called the
        Random Activity Group aimed at providing young adults an opportunity to hang out with other young adults doing
        ...
        parties, man parties, shooting range, festivals, the list is endless. although I am no longer an active
        organiser in Random Activity Group, it still lives on through others I've also promoted to organisers as well to
        keep it alive! We still have meetups multiple times every week.
      </div>
    </div>);
  }
}
